...
export async function getBookingById(id)             { return (await loadAdapter()).getBookingById(id) }
export async function addBooking(booking)            { return (await loadAdapter()).addBooking(booking) }
export async function updateBooking(booking)         { return (await loadAdapter()).updateBooking(booking) }
export async function deleteBooking(id)              { return (await loadAdapter()).deleteBooking(id) }
export async function decrementParkingFreeSpots(id)  { return (await loadAdapter()).decrementParkingFreeSpots(id) }
export async function incrementParkingFreeSpots(id)  { return (await loadAdapter()).incrementParkingFreeSpots(id) }
